// Linkage batch B2: delta specimens for cluster B. 2 saves.
var ID  = "Lk";
var URL = "fd://x";
...
// b_as0: exportForAS turned off (vs b_base1 baseline)
build("b_as0",   { AS:0, ff:0, RS:1, imp:0, url:URL }, { baseline:"b_base1" });
// b_imp: RS off, importForRS on (vs b_as0 baseline) — decodes RS and import bytes together
build("b_imp",   { AS:0, ff:0, RS:0, imp:1, url:URL }, { baseline:"b_as0" });
